...
class TestAppLogic(unittest.TestCase):
    ...
    def setUp(self):
        # Define file paths
        self.archivo_datos = "test_listado.csv"
        self.archivo_seguimiento = "test_seguimiento.csv"
        self.archivo_calendario = "test_calendario.csv"
    ...
    def test_cargar_datos_maestros(self):
        ...
        st.cache_data.clear()
        df = cargar_datos_maestros(self.archivo_datos)
    ...
    def test_cargar_seguimiento(self):
        ...
        df = cargar_seguimiento(self.archivo_seguimiento)
        self.assertIsNotNone(df)
    ...
    def test_guardar_seguimiento(self):
        ...
        guardar_seguimiento(df, self.archivo_seguimiento)
        df_updated = cargar_seguimiento(self.archivo_seguimiento)
